...
export default function Featured({type}) {
  return (
    <div className="">
      ...
      <img className="w-full object-cover" src="./assets/cover.jpg" alt="" />
      <div className="absolute bottom-44">
        <div className="flex flex-col w-[40%] ml-10">
          ...
          <div className="flex items-center">
            <div className="flex items-center bg-white px-6 py-3 m-2 ml-0 mr-6 rounded-lg text-[#080808]">
              <PlayArrowIcon />
              <span className="text-xl font-medium pl-1">Play</span>
            </div>
            <div className="flex items-center bg-[#595959] px-6 py-3 m-4 ml-0 rounded-lg text-white">
              <InfoIcon />
